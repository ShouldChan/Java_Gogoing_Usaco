 ...
 */
public class SuzhouSubwayTest {
    public static List<String> line1 = new ArrayList<String>();//#1号线
    public static List<String> line2 = new ArrayList<String>();//#2号线
    public static List<String> line4 = new ArrayList<String>();//#4号线

    public static Set<List<String>> lists = new HashSet<List<String>>();//所有线的集合
    public static int totalStation = 0;//总的站点数量
    public List<String> outlist = new ArrayList<String>();//记录分析过的点
...
//        }
        ...
        Iterator it1= line1.iterator();
        while(it1.hasNext()){
            System.out.println(it1.next());
        }
        totalStation = line1.size() + line2.size() + line4.size();
    }
